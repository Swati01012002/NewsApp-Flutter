                      ...
                      child: Card(
                        ...
                        child: Stack(
                          children: [
                            ClipRRect(
                              borderRadius: BorderRadius.circular(10),
                              child: Image.asset("images/image1.jpeg", fit: BoxFit.fitHeight,height: double.infinity,),
                            ),
                            Positioned(
                              left: 0,
                                right: 0,
                              ...
                              child: Container(
                                ...
                                child: Text("NEWS HEADLINE", style: TextStyle(
                                  fontSize: 18,
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold
                                ),),
                          ...
                          child: Card(
                            ...
                            child: Stack(
                              children: [
                                ClipRRect(
                                    borderRadius: BorderRadius.circular(15),
                                    child: Image.asset("images/image1.jpeg", width: double.infinity,fit: BoxFit.fitWidth,)),
                                Positioned(
                                    left: 0,
                                    right: 0,
                                    bottom: 0,
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text("BSJDDJOIDJODIJDJDOCDJDD", style: TextStyle(
